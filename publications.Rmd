...
- @rickard_mothers_2022 [<img src="images/pdf.png" width=20px style="float:none; vertical-align:middle; padding:0 0 0 0"/>](pdfs/bailey_bird_2022.pdf) is paper investigating the relationship between twinning and fertility in Humans and illustrating a new type of Simpson's paradox -- published in *Nature Communications*.
...
### All & none (purely theoretical) {#taxon_none}
