...
- @kravchenko_shorter_2025 [<img src="images/pdf.png" width=20px style="float:none; vertical-align:middle; padding:0 0 0 0"/>](kravchenko_shorter_2025.pdf) is a combination of physiological experiments and heavy computations to hindcast and forecast the impact of climate change onto the hibernation area of a European bat -- published in *Ecology Letters*.
